...
DATABASES = {
    'default': dj_database_url.config(
        default='postgresql://dahmani:CN8aA019RpIZCPb8n1Z2Ssnqwa13G2Lb@dpg-ctpifda3esus73dibgkg-a.frankfurt-postgres.render.com/mydatabase1_191m',  # Replace with your Render database URL
        conn_max_age=600,
        ssl_require=True,
    )
}
